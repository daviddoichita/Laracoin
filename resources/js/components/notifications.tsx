...
export default function Notifications() {
    return (
        <Toast.Provider limit={3} timeout={5000}>
            ...
            <Toast.Viewport className={"fixed right-[1rem] h-fit top-auto bottom-auto mx-auto flex w-[250px] sm:right-[2rem] sm:bottom-[2rem] sm:w-[300px]"}>
                <ToastList></ToastList>
            </Toast.Viewport>
        </Toast.Provider>
    )

...
export function CryptoDashPill({ crypto }: CryptoDashPillProps) {
    ...
    return (
        <Link
            ...
            className="flex max-w-7xl min-w-7xl flex-row items-center justify-between rounded border p-3 font-sans transition duration-[0.2s] ease-in-out hover:cursor-pointer hover:bg-neutral-300 dark:bg-neutral-950 dark:hover:bg-neutral-900"
        >
